...
model: GPT-4.1
 tools: ['editFiles', 'extensions', 'fetch', 'findTestFiles', 'githubRepo', 'problems', 'runCommands', 'runTask2', 'search', 'terminalLastCommand', 'usages', 'vscodeAPI', 'github', 'microsoft-docs', 'copilotCodingAgent']
---
