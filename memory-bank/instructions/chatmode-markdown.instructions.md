...
To switch between chat modes, open the Chat view (`kb(workbench.action.chat.open)`), and then select the desired mode from the chat mode dropdown list.
 <!-- https://github.com/microsoft/vscode-docs/blob/4fd6935f5165fcc0d09bc2ee35dc41bb30c9ff0d/docs/copilot/customization/custom-chat-modes.md -->
![Screenshot showing the Chat view, highlighting the chat mode dropdown list.](https://github.com/microsoft/vscode-docs/blob/4fd6935f5165fcc0d09bc2ee35dc41bb30c9ff0d/docs/copilot/chat/images/chat-modes/chat-mode-dropdown.png)
...
* [Get an overview of chat in VS Code](https://github.com/microsoft/vscode-docs/blob/4fd6935f5165fcc0d09bc2ee35dc41bb30c9ff0d/docs/copilot/chat/copilot-chat.md)
...
* [Configure tools in chat](https://github.com/microsoft/vscode-docs/blob/4fd6935f5165fcc0d09bc2ee35dc41bb30c9ff0d/docs/copilot/chat/chat-agent-mode.md#agent-mode-tools)
